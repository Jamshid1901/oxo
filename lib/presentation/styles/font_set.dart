...
class FontSet {
  ...
  static FontSet createOrUpdate(CustomColorSet colors) {
    return FontSet._(
      headline1: Style.regular34(size: 34.sp, color: colors.text),
      headline2: Style.regular24(size: 24.sp, color: colors.text),
      headline3: Style.medium20(size: 20.sp, color: colors.text),
      headline4: Style.semiBold14(size: 14.sp, color: colors.text),
      headline5: Style.bold16(size: 16.sp),
      headline6: Style.bold20(size: 20.sp, color: colors.text),
